...
export const modelColorMappings: Record<string, Record<string, string>> = {
  ...
  // iPhone 14 e 14 Plus — cores oficiais: Meia Noite (preto), Estelar (branco/prata), (PRODUCT)RED, Roxo, Azul, Amarelo
  'iphone 14': {
    'meia noite': 'Meia Noite',
    'meia-noite': 'Meia Noite',
    'midnight': 'Meia Noite',
  ...
  // iPhone 16 Pro e 16 Pro Max — cores oficiais: Titânio Deserto, Titânio Natural, Titânio Branco, Titânio Preto
  'iphone 16 pro': {
    'titânio deserto': 'Titânio Deserto',
    'titânio desert': 'Titânio Deserto',
    'desert titanium': 'Titânio Deserto',
    'titanium desert': 'Titânio Deserto',
    'desert': 'Titânio Deserto',
    'desert chip': 'Titânio Deserto',
    'titânio natural': 'Titânio Natural',
    'natural titanium': 'Titânio Natural',
    'titanium natural': 'Titânio Natural',
    'natural': 'Titânio Natural',
    'natural chip': 'Titânio Natural',
    'titânio branco': 'Titânio Branco',
    'white titanium': 'Titânio Branco',
    'titanium white': 'Titânio Branco',
    'titanium branco': 'Titânio Branco',
    'branco': 'Titânio Branco',
    'branco chip': 'Titânio Branco',
    'white': 'Titânio Branco',
    'titânio preto': 'Titânio Preto',
    'black titanium': 'Titânio Preto',
    'titanium black': 'Titânio Preto',
    'titanium preto': 'Titânio Preto',
    'preto': 'Titânio Preto',
    'black': 'Titânio Preto',
  },
  'iphone 16 pro max': {
  ...
  // iPhone 17 Pro e 17 Pro Max — cores oficiais: Azul Intenso, Laranja Cósmico, Prateado (Silver = Branco)
  'iphone 17 pro': {
    // Laranja Cósmico (Cosmic Orange) — fornecedores mandam "laranja", "latanja", etc.
    'laranja cósmico': 'Laranja Cósmico',
    'laranja cosmico': 'Laranja Cósmico',
    'cosmic orange': 'Laranja Cósmico',
    'laranja': 'Laranja Cósmico',
    'latanja': 'Laranja Cósmico',
    'orange': 'Laranja Cósmico',
    'cosmic': 'Laranja Cósmico',
    '🟠': 'Laranja Cósmico',
    '🧡': 'Laranja Cósmico',
    '🔶': 'Laranja Cósmico',
    ...
    '💙': 'Azul Intenso',
    '🔷': 'Azul Intenso',
    // Prateado (Silver = Branco para 17 Pro)
    'prateado': 'Prateado',
    'silver': 'Prateado',
    'prata': 'Prateado',
    'branco': 'Prateado',
...
const globalColorFallback: Record<string, string> = {
  ...
  'space gray': 'Cinza Espacial',
  'space grey': 'Cinza Espacial',
  spg: 'Cinza-espacial', // abreviação fornecedores (Space Gray)
}
